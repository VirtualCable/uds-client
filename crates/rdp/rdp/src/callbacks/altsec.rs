use freerdp_sys::{
    CREATE_NINE_GRID_BITMAP_ORDER, CREATE_OFFSCREEN_BITMAP_ORDER, DRAW_GDIPLUS_CACHE_END_ORDER, DRAW_GDIPLUS_CACHE_FIRST_ORDER, DRAW_GDIPLUS_CACHE_NEXT_ORDER, DRAW_GDIPLUS_END_ORDER, DRAW_GDIPLUS_FIRST_ORDER, DRAW_GDIPLUS_NEXT_ORDER, FRAME_MARKER_ORDER, STREAM_BITMAP_FIRST_ORDER, STREAM_BITMAP_NEXT_ORDER, SWITCH_SURFACE_ORDER, UINT8
};
